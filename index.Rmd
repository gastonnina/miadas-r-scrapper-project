...
# Cargar librerías necesarias para realizar solicitudes HTTP, parseo de HTML, manipulación de datos y manejo de texto
...
extraer_datos_totto <- function(url) {
  ...
  data.frame(
    ...
    precio = productos_html %>% html_element("span.__item-price") %>% html_text(trim = TRUE),
